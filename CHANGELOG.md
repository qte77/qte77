...
- `assets/images/icons/{mcp,uv,markdown}-{dark,light}.svg`: Tools-row marks for Model Context Protocol, uv (Astral), and Markdown — official CC0 mark paths from [Simple Icons](https://github.com/simple-icons/simple-icons) (like `claude.svg`), paired light/dark like the other monochrome icons and wired into the README `## Tools` row; `assets/images/icons/README.md` notes the Simple Icons provenance
